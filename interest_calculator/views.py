...
def calculate(request):
    ...
    if initial_deposit is None or interest_rate is None or monthly_deposit is None or interest_rate_interval is None:
...
def getGraphResults(initial_deposit, monthly_deposit, interest_rate, interest_rate_interval):
	...
	for month_num in range(1, 601):
		result.append({'month': month_num, 'amount': int(amount)})
